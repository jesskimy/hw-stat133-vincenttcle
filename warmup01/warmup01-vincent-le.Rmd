...
$$d(\textbf{p, q}) = d(\textbf{q, p}) = \sqrt{(q_1 - p_1)^2 + (q_2 - p_2)^2 + ... + (q_n -p_n)^2}  \\ = \sqrt{\sum_{i =1}^n (q_i - p_i)^2}$$
...
$$
\textbf{ q - p} = (q_1 - p_1, q_2 - p_2, ..., q_n - p_n)
$$
